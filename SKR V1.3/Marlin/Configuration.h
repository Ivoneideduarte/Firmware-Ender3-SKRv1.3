 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 200, 95 } // 160, 160, 200, 93
...
#define INVERT_X_DIR false  //funcionando no sentido correto
...
#define INVERT_E0_DIR false //funcionando no sentido correto
